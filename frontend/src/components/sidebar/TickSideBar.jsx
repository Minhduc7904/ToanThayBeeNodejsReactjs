...
const TickSideBar = ({ title, onClick, isChecked = false, type = "radio" }) => {
    ...
    const baseClasses = "w-4 h-4 flex items-center justify-center transition-all duration-150";
    ...
    return (
        ...
        >
            ...
            {/* Tiêu đề */}
            <div className="text-zinc-900 text-sm font-normal font-['Be_Vietnam_Pro'] capitalize">
                {title}
            </div>
        </div>
    );

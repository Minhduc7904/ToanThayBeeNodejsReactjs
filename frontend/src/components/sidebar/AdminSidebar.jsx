...
import { toggleDropdown } from '../../features/auth/sidebarSlice';
...
const AdminSidebar = () => {
    ...
    return (
        <div className="flex flex-col justify-between bg-white w-[18rem] h-full p-[1.25rem] rounded-[34px] shadow-[0px_1px_8px_2px_rgba(20,20,20,0.08)]">
            <div className="flex-col w-full justify-start items-start gap-5 inline-flex">
                <div className="flex w-full flex-row gap-[0.75rem] items-center p-[0.5rem] ">
                    <BeeMathLogo className='w-[2rem] h-[2rem]' />
                    <p className='p-0 font-bevietnam text-[#090a0a] text-2xl font-bold'>Toán thầy Bee</p>
                </div>

                <div className="flex flex-col gap-3 w-full">
                    <Link
                        to="/dashboard"
                        className={`p-3 w-full items-center rounded-lg gap-4 inline-flex ${location.pathname === '/dashboard' ? 'bg-[#253f61]' : 'bg-white'}`}
                    >
                        ...
                        <div className="text-[#253f61] text-base font-medium font-bevietnam leading-none">
                            Tổng quan
                        </div>
                    </Link>

                    <button
                        className={`p-3 w-full items-center rounded-lg gap-4 inline-flex ${dropdown ? 'bg-[#253f61]' : 'bg-white'}`}
                    ...
                    >
                        ...
                        <div className='flex w-[14rem] justify-between items-center flex-row'>
                            <div className={`${dropdown ? 'text-white' : 'text-[#253f61]'} text-base font-medium font-bevietnam leading-none`}>
                                Quản lý
                            </div>
                        ...
                        <div className='flex flex-col w-full'>
                            ...
                            >
                                <div className="self-stretch p-3 justify-center items-center gap-4 inline-flex">
                                    <div className={`grow shrink basis-0 text-base font-medium font-bevietnam leading-none text-[#253f61] ${location.pathname === '/admin/student-management' ? 'underline' : ''}`}>Học sinh</div>
                                </div>
                            </Link>
                            <Link
                                to={'/admin/class-management'}
                                className="w-[248px] h-11 pl-9 flex-col justify-center items-center gap-[7px] inline-flex"
                            >
                                <div className="self-stretch p-3 justify-center items-center gap-4 inline-flex">
                                    <div className={`grow shrink basis-0 text-base font-medium font-bevietnam leading-none text-[#253f61] ${location.pathname === '/admin/class-management' ? 'underline' : ''}`}>Lớp học</div>
                                </div>
                            </Link>
                            <Link
                            ...
                            >
                                <div className="self-stretch p-3 justify-center items-center gap-4 inline-flex">
                                    <div className={`grow shrink basis-0 text-base font-medium font-bevietnam leading-none text-[#253f61] ${location.pathname === '/admin/question-management' ? 'underline' : ''}`}>Câu hỏi</div>
                                </div>
                            </Link>
                            <Link
                            ...
                            >
                                <div className="self-stretch p-3 justify-center items-center gap-4 inline-flex">
                                    <div className={`grow shrink basis-0 text-base font-medium font-bevietnam leading-none text-[#253f61] ${location.pathname === '/admin/exam-management' ? 'underline' : ''}`}>Đề thi</div>
                                </div>
                            </Link>
                            <div className="w-[248px] h-11 pl-9 flex-col justify-center items-center gap-[7px] inline-flex">
                                <div className="self-stretch p-3 justify-center items-center gap-4 inline-flex">
                                    <div className="grow shrink basis-0 text-[#253f61] text-base font-medium font-bevietnam leading-none">Lý thuyết</div>
                                </div>
                            </div>
                        </div>
                    )}

                    <div className="p-3 w-full items-center rounded-lg gap-4 inline-flex">
                        <div data-svg-wrapper className="relative">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="flex-col justify-start items-start gap-3 inline-flex">
                <div className="h-11 w-full flex-col justify-center items-center inline-flex">
                    <div className="w-full self-stretch p-3 justify-center items-center gap-4 inline-flex">
                        <div data-svg-wrapper className="relative">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className='flex w-full items-center justify-between flex-row'>
                            <div className=" grow shrink basis-0 text-[#253f61] text-base font-medium font-bevietnam leading-none">Thông báo</div>
                ...
                <div className="h-11 w-full flex-col justify-center items-center inline-flex">
                    <div className="w-full self-stretch p-3 justify-center items-center gap-4 inline-flex">
                        ...
                        <div className=" grow shrink basis-0 text-[#253f61] text-base font-medium font-bevietnam leading-none">Cài đặt</div>
                    </div>
                </div>
                <div className="h-11 w-full flex-col justify-center items-center inline-flex">
                    <div className="w-full self-stretch p-3 justify-center items-center gap-4 inline-flex">
                        ...
                        <div className=" grow shrink basis-0 text-[#253f61] text-base font-medium font-bevietnam leading-none">Đăng xuất</div>
                    </div>
                </div>
            </div>
        </div>

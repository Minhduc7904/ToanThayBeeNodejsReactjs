...
const ExamDetail = () => {
    ...
    return (
        <UserLayout>
            <div className="flex flex-col overflow-y-auto hide-scrollbar items-center bg-[#F6FAFD] px-4 py-6">
                            ...
                            {exam?.imageUrl && (
                                <div className="w-full flex justify-center overflow-x-auto">
                                    <img
                                        src={exam?.imageUrl}
                                        alt={exam?.name}
                                        className="rounded-md max-h-[40rem] w-full sm:w-auto object-contain border"
                                    />
                                </div>

...
const ClassUserPage = () => {
    ...
    return (
        <UserLayout>
            ...
            <div className="h-[100vh] flex flex-col overflow-y-auto hide-scrollbar items-center bg-white pt-10 px-4 gap-8">
                ...
                <div className="w-full block lg:hidden space-y-4">
                    {paginatedClasses.length > 0 ? (
                        paginatedClasses.map((cls, index) => (
                            <div key={cls._id} onClick={() => navigate(`/class/${cls.class_code}`)} className="p-4 border rounded-lg shadow-sm hover:bg-gray-50 cursor-pointer">

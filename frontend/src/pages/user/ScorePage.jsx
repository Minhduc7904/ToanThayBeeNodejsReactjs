                            ...
                            <div className="flex justify-center flex-col gap-4">
                                ...
                                <div className="w-full flex flex-col">
                                    ...
                                    <div className="flex justify-between items-center flex-wrap">
                                        <p className="text-2xl font-bold text-zinc-800">📊 Thống kê kết quả</p>

                                        {score !== undefined && (
                                            <div className="inline-block px-5 py-2.5 bg-gradient-to-r from-green-400 to-blue-500 text-white font-semibold text-lg rounded-lg shadow-md">
                                    ...
                                    <div className="w-full lg:h-[16.25rem] flex flex-col md:flex-row justify-center items-center md:items-start gap-6">
                                ...
                                <hr className="my-4" />
                                <p className="text-2xl font-bold text-zinc-800">📝 Chi tiết bài làm</p>
                                <hr className="my-4" />
                                <div className={`w-full min-h-full rounded-md flex flex-col gap-4 bg-white text-black`}>
                                    <div className="flex flex-row justify-around text-xl font-bold gap-4">
                                        <p
                                            onClick={() => {
                                                setIsPart1(true);
                                                setIsPart2(false);
                                            ...
                                            className={`cursor-pointer ${isPart1 ? 'text-blue-500' : 'text-gray-500'}`}
                                        >Phần I - Trắc nghiệm </p>
                                        <p
                                            onClick={() => {
                                                setIsPart1(false);
                                                setIsPart2(true);
                                            ...
                                            className={`cursor-pointer ${isPart2 ? 'text-blue-500' : 'text-gray-500'}`}
                                        >Phần II - Đúng sai </p>
                                        <p
                                            onClick={() => {
                                                setIsPart1(false);
                                            ...
                                            className={`cursor-pointer ${isPart3 ? 'text-blue-500' : 'text-gray-500'}`}
                                        >Phần III - Trả lời ngắn </p>
                                    </div>
                                    <hr className="my-4" />
                                    {
                                        isPart1 && (
                                            ...
                                            <div className="flex flex-col gap-4">
                                                {questionDS.map((question, idx) => (
                                                    ...
                                                    >
                                                        ...
                                                        <div className="flex flex-col gap-2">
                                                            <table className="table-auto w-full text-sm border border-zinc-300 shadow-sm rounded-md overflow-hidden mb-4">
                                                                <thead className="bg-zinc-100 text-zinc-700 uppercase text-xs font-semibold">
                                                                    <tr>
                                                                        <th className="border px-3 py-2 text-left w-[70%]">Mệnh đề</th>
                                                                        <th className="border px-3 py-2 text-center w-[10%]">Trả lời</th>
                                                                        <th className="border px-3 py-2 text-center w-[10%]">Đáp án</th>
                                                                        <th className="border px-3 py-2 text-center w-[10%]">Kết quả</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    {question.statements.map((statement, index) => {
                                                                            ...
                                                                            <tr key={statement.id} className={`border ${isCorrect ? 'bg-green-50' : 'bg-red-50'}`}>
                                                                                ...
                                                                                <td className="border px-3 py-2">
                                                                                    <div className="flex items-start gap-2">
                                                                                        <span className="font-bold">{prefixStatementDS[index]}</span>
                                                                                        <div className="flex flex-col gap-2">
                                                                                            ...
                                                                                            {statement.imageUrl && (
                                                                                                <div className="w-full max-w-xs mx-auto">
                                                                                                    <img
                                                                                                        ...
                                                                                                        alt="statement"
                                                                                                        className="object-contain w-full h-40 rounded border"
                                                                                                    />
                                                                                                </div>
                                                                                            )}
                                                                                        </div>
                                                        ...
                                                        >
                                                            ...
                                                            <div className="mt-2 p-3 border rounded bg-gray-50">
                                                                ...
                                                                <div className="whitespace-pre-line text-gray-800">
                                                                    {userAnswer.trim() !== "" ? JSON.parse(userAnswer) : "Chưa trả lời."}
                                                                </div>
                                                            </div>
